...
public class TownStandardNumService implements ITownStandardNumService{
	...
	public List<HashMap<String, Object>> townStandardNum(String townNum) {
			...
			for(int i = realTime;;i++){
				...
				if(vilColls.size()>0){
					...
					vilEvaNum = this.townStandardNum(vils, i);
		...
		public int townStandardNum(List<VilBasicInfo> vilBasicInfo, int collYear){
