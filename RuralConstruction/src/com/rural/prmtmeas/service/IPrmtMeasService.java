...
public interface IPrmtMeasService {
	...
	/*public abstract void addTownContact(int basicInfoID,String contactNum,String contactName,String contactTel,String contactComp,String contactPost,String contactNote);
	public abstract void updateTownContact(int contactID,String contactNum,String contactName,String contactTel,String contactComp,String contactPost,String contactNote);
	public abstract void delTownContact(int contactID);
	
	public abstract void addCountryContact(int basicInfoID,String contactNum,String contactName,String contactTel,String contactComp,String contactPost,String contactNote);
	public abstract void updateCountryContact(int contactID,String contactNum,String contactName,String contactTel,String contactComp,String contactPost,String contactNote);
	public abstract void delCountryContact(int contactID);
	
	public abstract void addCitysContact(int basicInfoID,String contactNum,String contactName,String contactTel,String contactComp,String contactPost,String contactNote);
	public abstract void updateCitysContact(int contactID,String contactNum,String contactName,String contactTel,String contactComp,String contactPost,String contactNote);
