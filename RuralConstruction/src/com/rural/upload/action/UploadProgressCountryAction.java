...
public class UploadProgressCountryAction extends ActionSupport {
	private static final long serialVersionUID = 1L;
	private Map<String, Object> dataMap = new HashMap<String, Object>();
	
	public String execute() throws Exception {
		int totalRows = UploadCountryAction.totalRows;
		int handleRows =  UploadCountryAction.handleRows;
