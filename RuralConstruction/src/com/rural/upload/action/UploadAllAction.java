...
public class UploadAllAction  extends ActionSupport{
	   ...
	   // private DataCollDataDicDAO dataCollDataDicDAO = new DataCollDataDicDAO();
	    ...
	    public void uploadAll() throws Exception {
			...
			try {
		        ...
		        uploadPath = ServletActionContext.getRequest().getSession().getServletContext().getRealPath("/DataInput");  
		        //目录如果不存在先创建  
	    ...
	    public String deleteAll() throws Exception {
	    	ServletActionContext.getResponse().setContentType("text/html; charset=utf-8");
	    	  ...
	    	  String uploadPath = ServletActionContext.getRequest().getSession().getServletContext().getRealPath("/DataInput");  
