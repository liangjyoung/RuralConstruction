		...
		<script type="text/javascript">
			...
			jQuery(function($) {
                ...
                sortable: false
					     ...
					     {name:'dataCollDicEntryId',index:'dataCollDicEntryId', width:60, sorttype:"int", editable: false,search:false,hidden:true},
				...
				//var ids =jQuery(grid_selector).jqGrid("getGridParam","selrow");
                  $($(this)[0]).find("input[name='myId']")[rowid - 1].checked = true;
             },
			...
			function ss (cellvalue, options, rowObject){
					
		return "<input type='radio' name='myId' value='"+cellvalue+"' onclick=\"radioSelect('myId', '#grid-table')\" />";
                }
				...
				var sss=$("#sss").val();
					var sss=parseInt(sss);
						 var DataCollDataDicId = $("#DataCollDataDicId").val();
					var ids4=$(grid_selector2).jqGrid("getGridParam","selrow");//获得单行id
					 var rowDate = $("#grid-table2").jqGrid('getRowData', ids4); 
	             
	             ids=rowDate.dataCollDicEntryId; 
				...
				$("#nData").click(function(){
				 var DataCollDataDicId = $("#DataCollDataDicId").val();
					var ids4=$("#grid-table2").jqGrid("getGridParam","selrow");//获得单行id
					 var rowDate = $("#grid-table2").jqGrid('getRowData', ids4); 
