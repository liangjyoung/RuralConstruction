...
<html lang="en">
	...
	<body>
						...
						<div class="row"> 
							<div class="col-xs-12"> 
								<!-- PAGE CONTENT BEGINS -->
										...
										<div id="dropzone">
									      <form action="../../uploadImg.action" class="dropzone" method="post" enctype="multipart/form-data" id="dropzoneForm">
										  <div class="fallback">
		...
		function delImg(file){
    		$.ajax({
				url: "../../deleteImg.action?file="+file,
				datatype:"json",
				type:'post',
				//async: false,
				success:function(data)	//success callback
		...
		try {
				$(".dropzone").dropzone({
					...
					maxFilesize: 20, // MB
					acceptedFiles:  ".jpg,.png,.gif,.bmp,.jpeg,.JPG,.PNG,.GIF,.BMP,.JPEG,.xls,.docx,.doc,.txt" ,//,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet",
					addRemoveLinks : "true",
					//uploadMultiple:"true",
					...
					init: function() {
						...
						var VilDataCollRecID = $("#VilDataCollRecID").val();
					          $.ajax({
									url: "../../duixiang_UploadFile.action?vfile="+encodeURI(encodeURI(file.name))+"&InvesObjId="+InvesObjId+"&VilDataCollRecId="+VilDataCollRecID,
									datatype:"json",
									type:'post',
									//async: false,
									success:function(data)	//success callback
						...
						//});
				         ...
				         $.ajax({
				url: "../../deleteImg.action?fileName="+file.name,
				datatype:"json",
				type:'post',
				//async: false,
				success:function(data)	//success callback
