		...
		<div class="main-container" id="main-container" style="margin-top:27px">
			...
			<%@ include file="base/menu.html"%>	
				<div class="main-content">
					...
					<li id = "shan"class="active">
						<a data-toggle="tab" href = "#sector" id ="sect">
								扇形统计图
						</a>
					</li>
					<li id = "zhe">
				...
				<div class="tab-content">
						...
						<div class="row">							
								...
								<div class="widget-body">
									<div class="widget-main padding-4">
										<div id="sales-charts"style="width:500px;height:200px"></div>
									</div><!-- /widget-main -->
								</div><!-- /widget-body -->
					...
					<div id="sector" class="tab-pane in active">
						<div class="row">
								...
								<div class="widget-body">
									<div class="widget-main padding-4">
										<div id="piechart-placeholder" style="width:500px;height:200px"></div>
...
<![endif]-->
		...
		//alert(lineData);
				 ...
				 var fullDate="";  //所有年度
				var zeroSco="";  //所有0分项数
				var improSco=""; //所有需提升项数
				var mindate=0;
				var maxdate=0;
				var maxSco=0;
					
					fullDate =lineData[0].collTime.substring(0,4);
					maxdate = fullDate;
					mindate = fullDate;
						for(var i=0;i<lineData.length;i++){
						fullDate =lineData[i].collTime.substring(0,4);		
						fullSco= lineData[i].fullMarks;
						improSco=lineData[i].marks;
						zeroSco=lineData[i].zeroMarks;
						//alert(fullSco);
						d1.push([fullDate, fullSco]);
						d2.push([fullDate, improSco]);
						d3.push([fullDate, zeroSco]);
						if(fullDate>maxdate){
							maxdate = fullDate;
						}
						if(fullDate<mindate){
						...
						var widthss =$("#myTab4").width();
						//alert(widthss);
						//var sales_charts = $('#sales-charts').css({'width':widthss-20, 'height':'210px'});
						$.plot("#sales-charts", [
			...
			function pie(rowData){
				//alert("hahah");
				var sfullSco="";	//所有达标项数
				var szeroSco="";  //所有0分项数
				var simproSco=""; //所有需提升项数
				
				sfullSco= rowData.fullMarks;
				simproSco=rowData.marks;
				szeroSco=rowData.zeroMarks;
				
				//alert("sfullSco---->:"+sfullSco+"====simproSco---->"+simproSco+"===szeroSco------>:"+szeroSco);
			 var placeholder = $('#piechart-placeholder');//.css({'width':'580px' , 'min-height':'220px'});
			  
			var data = [
				{ label: "已达标",  data: sfullSco, color: "#FEE074"},
				{ label: "需提升",  data:simproSco, color: "#2091CF"},
				{ label: "0分",  data:szeroSco, color: "#AF4E96"}
			...
			//定义树的数据结构形式——————这是个对象
			    ...
			    onSelectRow: function ()  {   
						...
						rowName=encodeURI(encodeURI(rowName));
						pie(rowData);
					...
					loadComplete : function() {
						var table = this;
						lineData ="";
						lineData = $("#grid-table").jqGrid("getRowData");  //获取页面显示的所有数据
						...
						if(rowIds == ""||rowIds ==null){
						 $(grid_selector1).clearGridData(); 
						  $(grid_selector2).clearGridData(); 
						   $(grid_selector3).clearGridData();
						  
						  lineData = [{"evalScoId": "","collTime": "","fullMarks": "","zeroMarks": "","marks": ""}];
						   lineData2 = [{"evalScoId": "0","collTime": "0","fullMarks": "0","zeroMarks": "0","marks": "0"}];
						 linechart(lineData);
						 pie(lineData);
						 if($(".norecords").html() == null){
						               // $("#list").parent().append("<div class=\"norecords\">没有符合数据</div>");
										$(grid_selector).append("<div class=\"norecords\">暂无数据</div>");
									}
									$(".norecords").show();
			...
			jQuery(grid_selector3).jqGrid({
				...
				//navButtons
				jQuery(grid_selector3).jqGrid('navGrid',grid_selector3,
					{ 	//navbar options
					   cloneToTop:true,
						edit: false,
						editicon : 'icon-pencil blue',
				...
				function enableTooltips(table) {
		          ...
		          $("#grid-table1_toppager_center").hide();
				    ...
				    $("#grid-table2_toppager_right").hide();
		             ...
		             $("#grid-table3_toppager_center").hide();
				    $("#grid-table3_toppager_right").hide();
