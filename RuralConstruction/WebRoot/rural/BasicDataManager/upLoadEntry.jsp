...
<html lang="en">
	...
	<body>
							...
							<div class="col-xs-12"> 
								<!-- PAGE CONTENT BEGINS -->
								   <div class="alert alert-info">
								     ...
								     <div class="alert alert-info">
										<i class="icon-hand-right"></i>
										注意：在导入数据字典条目之前，请确保其所属的数据字典已经导入，否则导入失败！
										<button class="close" data-dismiss="alert">
											<i class="icon-remove"></i>
										</button>
								    </div>
									<div class="alert alert-info">
										<i class="icon-hand-right"></i>
										下载数据字典条目模板
										<a href="../../downloadEntry.action" class="btn btn-purple btn-sm">
											下载模板	
										...
										<font color="red">字段顺序必须与模板一致，所有字段必填。</font>
									</div>
										...
										<div id="dropzone">
									      <form action="../../uploadEntry.action" class="dropzone" method="post" enctype="multipart/form-data" id="dropzoneForm">
										  <div class="fallback">
		...
		function getProgress(){
    		$.ajax({
				url: "../../uploadProgressEntry.action",
				datatype:"json",
				type:'post',
				//async: false,
