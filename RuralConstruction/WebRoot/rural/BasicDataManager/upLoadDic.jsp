								...
								<!-- PAGE CONTENT BEGINS -->
								  <div class="alert alert-info">
									...
									<div class="alert alert-info">
										<i class="icon-hand-right"></i>
										下载数据字典模板
										<a href="../../downloadDic.action" class="btn btn-purple btn-sm">
											下载模板	
										...
										<div id="dropzone">
									      <form action="../../uploadDic.action" class="dropzone" method="post" enctype="multipart/form-data" id="dropzoneForm">
										  <div class="fallback">
