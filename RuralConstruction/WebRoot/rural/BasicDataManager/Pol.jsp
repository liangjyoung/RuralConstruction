		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:'../../Pol_managePol.action?oper=search',
					//data: grid_data,
					datatype: "json",
					mtype:"post",
					height: 445,
					colNames:['id','政治面貌编码','政治面貌名称'],
					colModel:[
						{name:'id',index:'PolID', width:60, sorttype:"int",key:true, editable: false,search:false,hidden:true},
						{name:'polCode',index:'polCode', width:60, sorttype:"int",editable: true,editrules:{required:true,custom:true,custom_func:polCodeCheck},formoptions:{elmsuffix:"<font color='red'>*</font>"}},

						{name:'polName',index:'polName',width:90, editable: true,editoptions:{size:"20",maxlength:"8"},editrules:{required:true},formoptions:{elmsuffix:"<font color='red'>*</font>"}}						//{name:'nothing',index:'', width:80, fixed:true, sortable:false, resize:false,
						//	formatter:'actions', 
						//	formatoptions:{ 
						//		keys:true,
						//		
					...
					editurl: "../../Pol_managePol.action",//nothing is saved
					caption: "政治面貌",
				...
				//验证政治代码的唯一性
				function polCodeCheck(value,colname){
					if(value.length!=0){
					...
					$.ajax({
						type : "get",
						async: false,
						url : "../../Pol_checkPolCode.action?polCode="+value+"&id="+id,
						dataType : "json",
