		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:'../../ExpertMajorCatg_manageExpertMajorCatg.action?oper=search',
					//data: grid_data,
					datatype: "json",
					mtype:"post",
					height: 445,
					colNames:['id','专业类别编码','专业类别名称'],
					colModel:[
						{name:'id',index:'id', width:60, sorttype:"int",key:true, editable: false,search:false,hidden:true},
						{name:'ExpertMajorNum',index:'ExpertMajorNum', width:60, sorttype:"int",editable: true,editrules:{required:true,custom:true,custom_func:expertMajorCatgNumCheck},formoptions:{elmsuffix:"<font color='red'>*</font>"}},
						
						{name:'ExpertMajorCatg',index:'ExpertMajorCatg',width:90, editable: true,editoptions:{size:"20",maxlength:"10"},editrules:{required:true},formoptions:{elmsuffix:"<font color='red'>*</font>"}}						//{name:'nothing',index:'', width:80, fixed:true, sortable:false, resize:false,
						//	formatter:'actions', 
						//	formatoptions:{ 
						//		keys:true,
						//		
					...
					editurl: "../../ExpertMajorCatg_manageExpertMajorCatg.action",//nothing is saved
					caption: "专业类别",
				...
				//验证性别代码的唯一性
				function expertMajorCatgNumCheck(value,colname){
					if(value.length!=0){
					...
					if(!reg.test(value)){
						return [false,"专业类别编号由2位大写字母和3位数字组成!"];
					}else{
					...
					$.ajax({
						type : "get",
						async: false,
						url : "../../ExpertMajorCatg_checkExpertMajorNum.action?expertMajorNum="+value+"&id="+id,
						dataType : "json",
				...
				jQuery(grid_selector).jqGrid('navGrid',grid_selector,
					...
					},
					{
						...
						url: '../../ExpertMajorCatg_manageExpertMajorCatg.action',  
						mtype: 'POST',
