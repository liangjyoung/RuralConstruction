...
<![endif]-->
		...
		</script><script src="assets/js/bootstrap.min.js"></script><script src="assets/js/typeahead-bs2.min.js"></script></strong>
...
<![endif]-->
		...
		<script type="text/javascript">
			/*var grid_data = 
			[ 
				{id:"1",code:"0",name:"未知的性别"},
				{id:"2",code:"1",name:"男性"},
				{id:"3",code:"2",name:"女性"},
				{id:"4",code:"9",name:"未说明的性别"}
			];	*/
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:'../../Nation_manageNation.action?oper=search',
					//data: grid_data,
					datatype: "json",
					mtype:"post",
					height: 445,
					colNames:['id','民族编码','民族名称'],
					colModel:[
					{name:'id',index:'id', width:60, sorttype:"int",key:true, editable: false,search:false,hidden:true},
						{name:'nationCode',index:'nationCode', width:60, sorttype:"int", editable: true,editrules:{required:true,custom:true,custom_func:nationCodeCheck},formoptions:{elmsuffix:"<font color='red'>*</font>"}},
						

						{name:'nationName',index:'nationName',width:90, editable: true,editoptions:{size:"20",maxlength:"10"},editrules:{required:true},formoptions:{elmsuffix:"<font color='red'>*</font>"}}						//{name:'nothing',index:'', width:80, fixed:true, sortable:false, resize:false,
						//	formatter:'actions', 
						//	formatoptions:{ 
						//		keys:true,
						//		
					...
					editurl: "../../Nation_manageNation.action",//nothing is saved
					caption: "民&nbsp;&nbsp;&nbsp;&nbsp;族",
				...
				//验证民族代码的唯一性
				function nationCodeCheck(value,colname){
					if(value.length!=0){
					...
					$.ajax({
						type : "get",
						async: false,
						url : "../../Nation_checkNationCode.action?nationCode="+value+"&id="+id,
						dataType : "json",
				...
				jQuery(grid_selector).jqGrid('navGrid',grid_selector,
					...
					},
					{
						...
						url: '../../Nation_manageNation.action', 
						mtype: 'POST',
