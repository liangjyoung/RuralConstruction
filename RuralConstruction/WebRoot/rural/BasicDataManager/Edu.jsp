...
<![endif]-->
		...
		<script type="text/javascript">
			/*var grid_data = 
			[ 
				{id:"1",code:"11",name:"博士研究生毕业",comment:"",},
				{id:"2",code:"12",name:"博士研究生结业",comment:""},
				{id:"3",code:"13",name:"博士研究生肄业",comment:""}
			];	*/
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:'../../Edu_manageEdu.action?oper=search',
					//data: grid_data,
					datatype: "json",
					mtype:"post",
					height: 445,
					colNames:['id','学历编码','学历名称'],
					colModel:[
						{name:'id',index:'id', width:60, sorttype:"int",key:true, editable: false,search:false,hidden:true},
						{name:'eduCode',index:'eduCode', width:60, sorttype:"int",editable: true,editrules:{required:true,custom:true,custom_func:eduCodeCheck},formoptions:{elmsuffix:"<font color='red'>*</font>"}},
						
						{name:'eduName',index:'eduName',width:90, editable: true,editoptions:{size:"20",maxlength:"10"},editrules:{required:true},formoptions:{elmsuffix:"<font color='red'>*</font>"}}
						//{name:'id',index:'id', width:60, sorttype:"int", editable: false,hidden:true},
						//{name:'code',index:'code',width:90, editable: true,editoptions:{size:"20",maxlength:"30"}},
						//{name:'name',index:'name', width:150,editable: true,editoptions:{size:"20",maxlength:"30"}},
						//{name:'comment',index:'comment', width:220, sortable:false,editable: true,edittype:"textarea", editoptions:{rows:"2",cols:"10"}}
						//{name:'nothing',index:'', width:80, fixed:true, sortable:false, resize:false,
						//	formatter:'actions', 
						//	formatoptions:{ 
						//		keys:true,
						//		
					...
					editurl: "../../Edu_manageEdu.action",//nothing is saved
					caption: "学&nbsp;&nbsp;&nbsp;&nbsp;历",
				...
				//验证学历代码的唯一性
				function eduCodeCheck(value,colname){
					if(value.length!=0){
					...
					$.ajax({
						type : "get",
						async: false,
						url : "../../Edu_checkEduCode.action?eduCode="+value+"&id="+id,
						dataType : "json",
