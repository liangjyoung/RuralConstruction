								...
								<!-- PAGE CONTENT BEGINS -->
								  <div class="alert alert-info">
									...
									<div class="alert alert-info">
										<i class="icon-hand-right"></i>
										下载市级区划模板
										<a href="../../downloadCity.action" class="btn btn-purple btn-sm">
											下载模板	
										...
										<font color="red">字段顺序必须与模板一致，编号、名称 
										字段必填。</font>
									</div>
										...
										<div id="dropzone">
									      <form action="../../uploadCity.action" class="dropzone" method="post" enctype="multipart/form-data" id="dropzoneForm">
										  <div class="fallback">
