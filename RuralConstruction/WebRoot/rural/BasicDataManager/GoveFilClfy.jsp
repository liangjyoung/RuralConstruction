		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:'../../GoveFilClfy_manageGoveFilClfy.action?oper=search',
					//data: grid_data,
					datatype: "json",
					mtype:"post",
					height: 445,
					colNames:['id','文件分类编码','文件分类名称','文件分类备注'],
					colModel:[
						{name:'id',index:'id', width:60, sorttype:"int",key:true, editable: false,search:false,hidden:true},
						{name:'goveFilClfyNum',index:'goveFilClfyNum', width:60, sorttype:"int",editable: true,editrules:{required:true,custom:true,custom_func:goveFilClfyNumCheck},formoptions:{elmsuffix:"<font color='red'>*</font>"}},
						{name:'goveFilClfyName',index:'goveFilClfyName',width:90, editable: true,editoptions:{size:"20",maxlength:"30"},editrules:{required:true},formoptions:{elmsuffix:"<font color='red'>*</font>"}},
						{name:'goveFilClfyNote',index:'goveFilClfyNote',width:90, editable: true,editoptions:{size:"20",maxlength:"200"}}
					...
					editurl: "../../GoveFilClfy_manageGoveFilClfy.action",//nothing is saved
					caption: "政府文件分类",
				...
				//验证政府文件分类编码的唯一性
				function goveFilClfyNumCheck(value,colname){
					if(value.length!=0){
					...
					if(!reg.test(value)){
						return [false,"文件分类编号由2位大写字母和2位数字组成!"];
					}else{
					...
					$.ajax({
						type : "get",
						async: false,
						url : "../../GoveFilClfy_checkGoveFilClfyNum.action?goveFilClfyNum="+value+"&id="+id,
						dataType : "json",
				...
				jQuery(grid_selector).jqGrid('navGrid',grid_selector,
					...
					},
					{
						...
						url: '../../GoveFilClfy_manageGoveFilClfy.action', 
						mtype: 'POST',
						closeAfterEdit: true,
