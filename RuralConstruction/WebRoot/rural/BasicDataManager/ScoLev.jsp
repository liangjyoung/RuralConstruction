		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					//direction: "rtl",
					url:'../../scorelevlmanager_manageScoreLevl.action?oper=search',
					//data: grid_data,
					datatype: "json",
					mtype:"post",
					height: 445,
					colNames:['scoLevId','得分级别编码','得分上限','得分下限'],
					colModel:[
						{name:'scoLevId',index:'scoLevId', width:60, sorttype:"int",key:true, editable: false,search:false,hidden:true},
						{name:'scoLevCode',index:'scoLevCode', width:60, sorttype:"int",editable: true,editrules:{required:true},formoptions:{elmsuffix:"<font color='red'>*</font>"}},
						
						{name:'scoUp',index:'scoUp',width:90, editable: true,editoptions:{size:"20",maxlength:"10"},editrules:{required:true},formoptions:{elmsuffix:"<font color='red'>*</font>"}},
						{name:'scoDown',index:'scoDown',width:90, editable: true,editoptions:{size:"20",maxlength:"10"},editrules:{required:true},formoptions:{elmsuffix:"<font color='red'>*</font>"}}
				    ...
				    prmNames : {
					    ...
					    id:"scoLevId", // 表示当在编辑数据模块中发送数据时，使用的id的名称  
					...
					editurl: "../../scolevsss_manageScoLev.action",//nothing is saved
					caption: "得分级别",
				...
				jQuery(grid_selector).jqGrid('navGrid',grid_selector,
					...
					},
					{
						...
						url: '../../scolevsss_manageScoLev.action', 
						mtype: 'POST',
						closeAfterEdit: true,
