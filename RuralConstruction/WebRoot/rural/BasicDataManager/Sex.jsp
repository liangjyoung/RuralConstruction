		...
		<script type="text/javascript">
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					url:'../../Sex_manageSex.action?oper=search',
					datatype: "json",
					mtype:"post",
					height: 445,
					colNames:['id','性别编码','性别名称'],
					colModel:[
						{name:'id',index:'id', width:60, sorttype:"int",key:true, editable: false,search:false,hidden:true},
						{name:'sexCode',index:'sexCode', width:60, sorttype:"int",editable: true,editrules:{required:true,custom:true,custom_func:sexCodeCheck},formoptions:{elmsuffix:"<font color='red'>*</font>"}},
						
						{name:'sexName',index:'sexName',width:90, editable: true,editoptions:{size:"20",maxlength:"6"},editrules:{required:true},formoptions:{elmsuffix:"<font color='red'>*</font>"}}						//{name:'nothing',index:'', width:80, fixed:true, sortable:false, resize:false,
					], 
					viewrecords : true,
					rowNum:50,
					rowList:[50,100,150],
					...
					editurl: "../../Sex_manageSex.action",//nothing is saved
					caption: "性&nbsp;&nbsp;&nbsp;&nbsp;别",
					autowidth: true
				});
				...
				//验证性别代码的唯一性
				function sexCodeCheck(value,colname){//value 是输入的值，colname是列名
					...
					$.ajax({
						type : "get",
						async: false,
						url : "../../Sex_checkSexCode.action?sexCode="+value+"&id="+id,
						dataType : "json",
