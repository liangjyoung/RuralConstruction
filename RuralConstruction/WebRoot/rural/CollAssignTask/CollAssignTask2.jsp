...
<![endif]-->
		...
		function AssignTask(InvgatID,InvgatNum) {
				...
				var a1 = "<iframe src='CollAssignTask3.jsp?InvgatID="+InvgatID+"&InvgatNum="+InvgatNum+"'style='width: 100%;height: 100%' scrolling='auto' frameborder='0'></iframe>";
				//alert(InvgatID);
			...
			jQuery(function($) {
				...
				jQuery(grid_selector).jqGrid({
					...
					colModel:[
					    {name:'id',index:'id', width:20, sorttype:"int", editable: true,key:true,hidden:true},
						{name:'InvgatNum',index:'InvgatNum', width:20, sorttype:"int", editable: true},
						{name:'InvgatName',index:'InvgatName', width:20,editable: true,editoptions:{size:"20",maxlength:"30"}},
						{name:'InvgatTel',index:'InvgatTel', width:30,editable: true,editoptions:{size:"20",maxlength:"30"}},
						{name:'InvgatComp',index:'InvgatComp', width:40, sortable:false,editable: true,edittype:"textarea", editoptions:{rows:"2",cols:"10"}},
						{name:'AssignTask',index:'AssignTask',formatter: experAssignTask, width:15,align:'center',search:false,sortable:false,},
					],
				...
				function experAssignTask(cellvalue, options, rowObject){
					...
					return "<input type='button' value='任务分配' onclick='AssignTask(\""+rowObject.id+"\",\""+rowObject.InvgatNum+"\")'/>";
					//alert(rowObject.InvgatID);
				} 
