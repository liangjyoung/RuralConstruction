				...
				<div class="main-content">
					...
					<!-- PAGE CONTENT BEGINS -->
							...
							<div  class="col-xs-3"style="height:100%">
								...
								<div class="widget-body" style="position:absolute;height:95%; width:100%;overflow:auto">
							...
							<div class="col-xs-9" style="overflow: scroll;">	    
								...
								<div style="width:880px;height:550px;overflow: scroll;">
								 <div id="ctvrank" style="width:800px;height:500px;" > </div>
								 </div>
		        ...
		        success: function (dataMap) {  
		            ...
		            {  
		                ...
		                if (dataMap.seriesData == null) {  
		                    ...
		                    option.yAxis[0].data = dataMap.xAxisData;
		                    //debugger
		                    if(dataMap.xAxisData.length <= 5)
		                    window.onresize = document.getElementById("ctvrank").style.height="250px";
		                } 
